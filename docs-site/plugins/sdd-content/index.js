...
module.exports = function(context, options) {
  ...
  // When the docs plugin is mounted at routeBasePath '/', the generated index
  // claims the site root. Set `generateIndex: false` to suppress it and serve
  // '/' from src/pages/index.tsx instead — the two would otherwise collide on
  // the same route. Everything else (decisions/, specs/, graph) is unaffected,
  // so this is the cheap way to get a real landing page without moving the
  // docs under a path prefix.
